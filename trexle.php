...
class Trexle extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->description = $this->l('Trexle module connecting PrestaShop to +100 payment gateway');
    ...
    public function uninstall()
    {
		...
		Configuration::updateValue('TREXLE_CHARGE');
            ...
            'form' => array(
                ...
                'input' => array(
					...
					array(
                        ...
                        'desc' => $this->l('Enter your Test Trexle API secret key '),
                    ...
                    array(
                        ...
                        'type' => 'text',
                          'prefix' => '<i class="icon icon-key"></i>',
                        'desc' => $this->l('Enter your Test Trexle API public key '),
                        'name' => 'TREXLE_PUBLISHABLE_KEY_TEST',
                        'label' => $this->l('Publishable Key Test'),
                    ),
						array(
						'col' => 3,
                        'type' => 'text',
						'tab' => 'config',
                        'prefix' => '<i class="icon icon-key"></i>',
                        'desc' => $this->l('Enter your Trexle API secret key '),
                    ...
                    array(
                        ...
                        'type' => 'text',
                          'prefix' => '<i class="icon icon-key"></i>',
                        'desc' => $this->l('Enter your Trexle API public key '),
                        'name' => 'TREXLE_PUBLISHABLE_KEY_LIVE',
                        'label' => $this->l('Publishable Key Live'),
                    ),
					  array(
                        'type' => $switch,
						'tab' => 'config',
    ...
    */
    ...
    public function hookPayment($params)
    {
		...
		if (Configuration::get('TREXLE_DEBUG'))
		{
			$this->log('Cart ID: '.$this->context->cart->id);
			$this->log('Total: '.$this->context->cart->getOrderTotal(true, Cart::BOTH));
			$this->log('this path: '.$this->getPathUri());
			$this->log('this path_ssl: '.Tools::getShopDomainSsl(true, true).__PS_BASE_URI__.'modules/'.$this->name.'/');
		}

		return $this->display(__FILE__, 'views/templates/front/paymentform.tpl');
